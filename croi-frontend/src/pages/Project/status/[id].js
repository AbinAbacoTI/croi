...
export default function DetailsProject(props){
    ...
    <>  
        ...
        <div className="flex h-auto flex-wrap mx-10 mb-14 mt-8">
            ...
            <img src={props.request_integer_detail.image} className="w-full 2xl:w-5/6 inset-0 object-cover object-center rounded-md lg:rounded-lg shadow-2xl lg:block h-96 lg:h-full" />
            </div>

            <div id="profile" className="w-full lg:w-3/5">
                <div className="p-4 md:p-12 text-center lg:text-left">
                    <h1 className="text-3xl font-bold pt-8 lg:pt-0">{props.request_integer_detail.name_project}</h1>
                    ...
                    <p className="pt-4 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                        ...
                        </svg>{props.request_integer_detail.address}</p>
                    <p className="mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-400 line-clamp-4">
                      {props.request_integer_detail.description}
                    </p>
