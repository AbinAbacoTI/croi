...
const handleSearchChangeNombre = (e) => {
   ...
   results = Projects.filter((project) =>
      project.request_integer_detail.name_project.toLowerCase().indexOf(e.target.value.toLowerCase()) >= 0
   )
   //console.log(results)
...
const handleSearchChangeFinanciamiento = (e) => {
   ...
   const abrirmodalEdit = (item) => {
      ...
      setNombre(item.request_integer_detail.name_project)
      setDireccion(item.request_integer_detail)
      setEstado(item.state)
      console.log(item)
      setCategoria(item.category)
      setUsuario(item.request_integer_detail.name_biznes)
  ...
  function CategoriaComponent(props) {
    ...
    Categories.forEach(function(cat){
         if(cat.category==props.item.name_category){
...
//   function FinanciamientoComponent(props) {
//    const [FinanciamientoUnico,setFinanciamientoUnico] = useState([])

//    finan.forEach(function(financi){
//         if(financi.id==props.item.type_financing){
//          console.log('hol')
//            console.log(props.item.type_financing)
//            FinanciamientoUnico.push(financi.type_financing)
//            console.log(FinanciamientoUnico)
//            console.log('hol')
//         }
//      });
...
//    return (
//      <>
//        <td class="px-4 py-3 text-sm border">{FinanciamientoUnico}</td>
//      </>
//    );
//  }
                                                ...
                                                <div class="mb-2 px-2">
                                                   ...
                                                   <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    onChange={handleSearchChangeCategoria}>
                                                        {Categories.map(item=>(
                                                            <option key={item.id} >{item.name_category}</option>
                                                        ))
                                                     ...
                                                     onChange={handleSearchChangeFinanciamiento}>
                                                        ...
                                                        <option value="L">P</option>
                                                         ...
                                                         {/* {filterProjects.map(item=>(
                                                             <option >{item.type_financing}</option>
                                                         ))
                                                         } */}
                                                         </select>
                                                    </div>
         ...
         {filterProjects.map((item, i) => {
            ...
            <td class="px-4 py-3 border">
              <div class="flex items-center text-sm">
                ...
                <div>
                  <p class="font-semibold text-black">{item.request_integer_detail.name_project}</p>
                </div>
              </div>
            </td>
            <td class="px-4 py-3 text-ms border">{item.request_integer_detail.address}</td>
            <td class="px-4 py-3 text-xs border">
            ...
            <td class="px-4 py-3 text-xs border">
              <span class="px-2 py-1 font-semibold leading-tight text-blue-700 bg-blue-100 rounded-sm">{item.request_integer_detail.name_biznes} </span>
            </td>
            <td class="px-4 py-3 text-xs border">
